...
void MAX44009_Config(void)
{
    ...
    RCC_AHB1PeriphClockCmd(MAX44009_I2Cx_SDA_GPIO_CLK, ENABLE);

    /* SCL GPIO Clock enable */
    RCC_AHB1PeriphClockCmd(MAX44009_I2Cx_SCL_GPIO_CLK, ENABLE);
    ...
    GPIO_PinAFConfig(MAX44009_I2Cx_SCL_GPIO_PORT, MAX44009_I2Cx_SCL_SOURCE, MAX44009_I2Cx_SCL_AF);

    /* Connect PXx to I2C_SDA */
    GPIO_PinAFConfig(MAX44009_I2Cx_SDA_GPIO_PORT, MAX44009_I2Cx_SDA_SOURCE, MAX44009_I2Cx_SDA_AF);
